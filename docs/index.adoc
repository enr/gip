...
- `tags` — optional list of labels used to filter projects with `--tag`
...
Add a `tags` list to any project in the configuration file and use `--tag` to restrict any command to a subset of projects.
...
# OR logic: repos with "js" or "personal"
